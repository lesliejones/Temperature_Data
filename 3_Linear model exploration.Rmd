...
STOPPED HERE, PARING DOWN COVARIATES BEFORE DOING MODEL SELECTION.
...
full.model.noint <- lm(meanT ~ tair3 + sweA1 + swe + prcp5 + reach_slope + 
                         Wetland + Shrub + Forest + Riparian + rca_elev_mn + 
                         ca_elev_mn + cont_area + elev_delta,
...
# Simple spring and fall models for testing predictions 
...
# Exploration of model types and fits
