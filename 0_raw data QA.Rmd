...
## APU Data
APU data doesn't seem like it has been QAed. Plot of raw data shows that sites 3 and 9 have some air temperature spikes.
...
Looked at this plot and found a bit more data Qa to do, notes are in the air temps workbook, 9/20/19.
