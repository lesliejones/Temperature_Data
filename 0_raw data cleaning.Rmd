...
Check that we have correct locations for all sites. Decided to drop Data logger 10 (APU13) per email from John Hagan that says it was a seep. Also manually corrected lat long for data logger 8 in the location csv that I imported to the datbase. APU now has 11 sites in the database.
