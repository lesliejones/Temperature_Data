...
#commented above out because I think your code below is referencing daymet dataframe from 1_Create model data frame.Rmd not the feature class in the geodatabase 
new_data_cl <- daymet %>%
