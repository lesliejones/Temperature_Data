...
pred_S4 <- sp::merge (rca_reach,preds_S4, by="rca_id") 
st_write(pred_S4, "Spatial_data/Anchor/shapefile_preds/preds_S4.shp", driver="ESRI Shapefile")
...
scen_change %>%
  ...
  labs(x = "Stream temperature change",
       ...
       subtitle = "Averages across all rcas and dates within each month")
